...
from ...symbols import SCONJ, CCONJ, CONJ, PROPN
from ...symbols import VerbForm_inf, VerbForm_none, Number_sing, Degree_pos


class LatinLemmatizer(Lemmatizer):
    """
    Latin language lemmatizer applies the default rule based lemmatization
    procedure with some modifications for better Latin language support.
...
#            univ_pos = "noun"
#        if univ_pos in (PROPN, "PROPN", "propn"):
#            univ_pos = "propn"
...
#            univ_pos = "sconj"
#        elif univ_pos in (CONJ,"CONJ","conj"):
#            univ_pos = "conj"
#        else:
